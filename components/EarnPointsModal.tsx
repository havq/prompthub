    ...
    const pointItems = [
        {
            ...
            icon: '🎨',
            title: t('earnPoints.items.promptRemixed.title'),
            desc: t('earnPoints.items.promptRemixed.desc'),
        ...
        },
        {
            ...
            icon: '📂',
            title: t('earnPoints.items.promptCollected.title'),
            desc: t('earnPoints.items.promptCollected.desc'),
        ...
        },
        {
            ...
            icon: '⭐',
            title: t('earnPoints.items.rating5Star.title'),
            desc: t('earnPoints.items.rating5Star.desc'),
        ...
        },
        {
            ...
            icon: '❤️',
            title: t('earnPoints.items.promptFavorited.title'),
            desc: t('earnPoints.items.promptFavorited.desc'),
        ...
        },
        {
            ...
            icon: '💬',
            title: t('earnPoints.items.commentReceived.title'),
            desc: t('earnPoints.items.commentReceived.desc'),
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-[80] p-4" onClick={onClose}>
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md relative overflow-hidden" onClick={e => e.stopPropagation()}>
                ...
                <div className="p-6 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center bg-gradient-to-r from-indigo-600 to-purple-600">
                    <div>
                        <h2 className="text-2xl font-bold text-white">{t('earnPoints.title')}</h2>
                        <p className="text-indigo-100 text-sm mt-1">{t('earnPoints.subtitle')}</p>
                    </div>
