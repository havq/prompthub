        ...
        <>
            ...
            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center space-x-2 z-30 pointer-events-none">
                ...
                {enableShowcaseUploads !== false && (
                    <button onClick={(e) => { e.stopPropagation(); onUploadShowcase(prompt); }} className="p-2 rounded-full bg-gray-900/60 text-gray-300 hover:bg-purple-600/80 hover:text-white transition-colors pointer-events-auto" title={t('promptCard.uploadShowcase')}>
