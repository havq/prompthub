  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="bg-white dark:bg-[#1c1f26] text-gray-800 dark:text-gray-300 text-sm rounded-md px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-indigo-500 border border-gray-300 dark:border-gray-800 transition-colors"
